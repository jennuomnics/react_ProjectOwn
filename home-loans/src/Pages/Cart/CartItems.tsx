...
const CartItems = ({cart}:cartSchema) => {
    ...
    const handleDesreaseQuantity = () => {
        dispatch(decreaseQuantity(cart.id))
    }

  return (
    <div className="w-100 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
      <div className="space-y-4 md:flex md:items-center  md:gap-6 md:space-y-0">
        ...
        {/* <div className="flex items-center justify-between md:order-3 md:justify-end">
          <div className="flex items-center">
            <button
              onClick={handleDesreaseQuantity}
              type="button"
        ...
        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
          ...
          >
            {cart.title} {cart.description} {cart.location}
          </a>
