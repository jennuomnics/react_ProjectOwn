...
export const addPlotValidation = [
  yup.object({
...
export const stepSchemas = [
  ...
  yup.object({
    ...
    bedrooms: yup.number().required("Bedrooms required").min(1),
    bathrooms: yup.number().required("Bathrooms required").min(1),
    kitchenCount: yup.number().required("Kitchen count required").min(1),
  }),

  yup.object({
    amenitiesNearby: yup.array().of(yup.string()),
...
export const addFlatValidation = [
  yup.object({
    title: yup.string().required("Title is Required"),
